...
@section('content')
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <form action="Contacts/s=" method="get"></form>
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Name, Lastname, Email" aria-label="Recipient's username" aria-describedby="button-addon2">
